...
@Repository
public class UserInMemoryDrivenAdapter implements
    ...
    public UserInMemoryDrivenAdapter(final UserInMemoryDb userInMemoryDb, final PersistenceInMemoryUserMapper persistenceInMemoryUserMapper) {
