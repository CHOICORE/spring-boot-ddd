...
import me.choicore.springbootddd.presentation.rest.adapter.user.dto.mapper.UserDtoMapper;
...
class UserApi {
    ...
    public ResponseEntity<ApiResponse<UserProfileResponseDto>> getUserProfile(@PathVariable("userId") Long userId) {
        ...
        UserProfile foundUserProfile = queryUserProfileUseCase.getUserProfile(userId);
    ...
    public ResponseEntity<ApiResponse<List<UserProfileResponseDto>>> getUserProfiles() {
        ...
        List<UserProfile> foundUserProfiles = queryUserProfileUseCase.getAllUserProfiles();
